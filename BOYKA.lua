...
sudo_users = {SUDO,1756511631,1900794631,1969546038}  
...
if tonumber(user_id) == tonumber(1756511631) then
var = true  
elseif tonumber(user_id) == tonumber(1900794631) then
var = true 
elseif tonumber(user_id) == tonumber(1969546038) then
var = true  
...
var = '〈 حبيب الكل 〉'
elseif tonumber(user_id) == tonumber(1900794631) then
var = 'عــــــمــو لــــيــل🧸'  
elseif tonumber(user_id) == tonumber(1969546038) then
var = 'عــــمــــو ايــــرور🧸'
elseif tonumber(user_id) == tonumber(SUDO) then
var = 'المطور الاساسي'  
elseif database:sismember(bot_id.."DEV:Sudo:T", user_id) then 
var = "المطور الاساسي²"  
...
local UserName = (data.username_ or "L_e_i_L4")
...
send(msg.chat_id_, msg.id_,'🧸 لا تستطيع استخدام البوت يرجى الاشتراك في القناة حتى تتمكن من استخدام ف \n 🧸 اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
if DevBOYKAW(msg) then
local bl = '🧸 اهلا عزيزي آلمـطـور\n🧸 آنت آلمـطـور آلآسـآسـي للبوت\n┉  ┉  ┉  ┉  ┉  ┉  ┉  ┉ء\n🧸 تسـتطـيع‌‏ آلتحگم باوامر البوت\n🧸 من خلاال الكيبورت خاص بك\n🧸 قناة سورس البوت [اضغط هنا](t.me/L_e_i_L4)'
local keyboard = {
...
os.execute('wget https://raw.githubusercontent.com/ghost091/jack/master/BOYKA.lua')
send(msg.chat_id_, msg.id_,'🧸 تم تحديث السورس \n🧸 لديك اخر اصدار لسورس ليل\n🧸 الاصدار » { 1.3v}')
dofile('BOYKA.lua')  
end
if text == 'الاصدار 🧸' and DevBOYKAW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'🧸 اصدار سورس ليل \n🧸 الاصدار »{ 1.3v}')
end
if text == 'قناه تحديثات البوت 🧸' and DevBOYKAW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'🧸 [تحديثات البوت](t.me/L_e_i_L4) \n🧸 [قناه السورس](t.me/L_e_i_L4)')
end
...
usertext = '\n🧸 العضو » ['..result.title_..'](t.me/'..(username or 'L_e_i_L4')..')'
status  = '\n🧸 تم ترقيته مطور'
...
usertext = '\n🧸 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'L_e_i_L4')..')'
status  = '\n🧸 تم ترقيته مطور'
...
if BOYKA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'🧸 العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'L_e_i_L4')..') \n🧸 '..BOYKA1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0,"🧸 العضو : {["..data.first_name_.."](T.ME/L_e_i_L4)}\n🧸 ["..BOYKA_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "🧸 عذرا » {["..data.first_name_.."](T.ME/L_e_i_L4)}\n🧸 عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
╔╦══════════• ✖‿✖ •════════╦╗
┊　　★                         🧸𝙻𝙴𝙸𝙻🧸           ★                     ┊
✖𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝙻𝙴𝙸𝙻 ✎
✖𝚃𝙷𝙴 𝙱𝙴𝚂𝚃 𝚂𝙾𝚄𝚁𝙲𝙴 𝙸𝙽 𝚃𝙴𝙻𝙴𝙶𝚁𝙰𝙼 ✎
✖𝙵𝙾𝙻𝙻𝙾𝚆 𝚃𝙷𝙴 𝙱𝚄𝚃𝚃𝙾𝙽𝚂 𝚃𝙾 𝙶𝙾 𝚃𝙾✎
✖𝚃𝙷𝙴 𝙿𝚁𝙾𝙶𝚁𝙰𝙼𝙼𝙴𝚁 𝙰𝙽𝙳 𝚃𝙷𝙴 𝙲𝙷𝙰𝙽𝙽𝙴𝙻✎ 
┊　　★                           🧸𝙻𝙴𝙸𝙻🧸            ★                ┊
╚╩══════════•✖‿✖•════════╩╝
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🧸𝙻𝙴𝙸𝙻🧸', url = "https://t.me/L_e_i_L0"}},
{{text = '🧸𝙴𝚁𝚁𝙾𝚁🧸', url = "https://t.me/ERR_O_R1"}},
{{text = '🧸𝚂𝙾𝚄𝚁𝙲𝙴 𝙻𝙴𝙸𝙻🧸', url = "https://t.me/L_e_i_L4"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/osso1000/54&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text ==  'منصور'  or text ==  'منص'  or text ==  'بتاع الحشيش'  or text ==   'ليل'  then
local Text = [[
اضــــغــــط هــــنــا للــــتــــواصــــل اتــبــع الــزر
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text ='🧸لــــــيــــل بتــاع الحــشــيش🧸' ,url="t.me/L_e_i_L1"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/L_e_i_L1&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'العالمي' or text == 'العالمي الهكر' or text == 'فلسطس الهكر' or text == 'فلسطس' then
Text = "[〈 حبيب الكل 〉](t.me/j333x) "
keyboard = {}
keyboard.inline_keyboard = {
{{text = '〈 حبيب الكل 〉',url="t.me/j333x"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/Source_Queen/1305&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--------------------------------------------------------------------------------------------------------------
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'🧸 بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'L_e_i_L4')..') \n🧸 تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'🧸 بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'L_e_i_L4')..') \n🧸 تـم قفـل التاك بالكتم ')
end,nil)   
...
if Get_info then
local TextS = "\n🧸 اهلا بك في متجر ملفات ليل\n🧸 ملفات السورس ↓\n•━━━━━━━━━━━━━•ٴ\n\n"
local TextE = "\n•━━━━━━━━━━━━━•ٴ\n🧸 علامة تعني { ✓ } ملف مفعل\n🧸 علامة تعني { ✘ } ملف معطل\n🧸 قناة سورس ليل ↓\n".."🧸 [اضغط هنا لدخول](t.me/L_e_i_L4) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_,"🧸 عذرا الملف لايدعم سورس ليل \n") 
end
return false
end
...
local TWEET_Msg = { 
"بـتــحــب مـــيـــن ؟💕", 
"مـــشـــتــاق لــ مــيــن؟💕", 
"عــاجــبـــك اســـمـــكـ ؟💕", 
"صــــوتـــك حـــلــو؟💕", 
"مــتـــضـــايـــق ؟🙂", 
"امـــنــيـــتــك؟✨", 
"فــي شـــخــص بـــتـكـلـمــو عــلــطـول؟🖤", 
"اشـــيـــاء نـــفـــســــكـ تـــجـــربـــهـــا؟🥀", 
"اتـــخـــزواقــت كــام مـــرهه؟💘", 
"مـــاهــو حـــيــوانــكـ الــــمــفـــضــل؟💕", 
"اخــر حــاجـــه عـــمــلتــها ونــدمــــان عــلــيـــهـا؟✨", 
"مـــيــن اقـــرب حـــد لـــيـــكـ ؟✨", 
"اي الــعـــيــــب الـــي فـــيـــكــ؟⚡", 
"اي اكـــتــر حــاجــه بـــتــحـــبـــطــكـ ؟🐥", 
"خــد دي نــصــيـحــه مش هيحبوك لو نضيف لكن هيحبوك لو بتكذب ", 
"يــــوم مــش هــتــنــســـاهه؟🍁 ", 
" تـــعــرف ٳٲٳيۧ عـــن  لــــيــــل؟🖤 ", 
"بــتــكــتــب تــويــت لــي طــب طــز فــيــكــ  ؟🔥 ", 
"صفة يطلقها عليك الشخص المفضّل؟ ", 
"أغنية عالقة في ذهنك هاليومين؟ ", 
"اكــلــه مــســتــحــيــل تــاكــلــهــا؟💘 ", 
"قــضــيــت يــومــك ف  ٳٲٳيۧ ؟🌟 ", 
"رايـــك ف الــعــالـم الــمـتـخـلـفـه الـي بــتـخـلـي حـد يـتـبنـهـا او يــتــجــوزهـا؟ 🌚 ", 
"اكـــتــر اكــلــه بــتــحــبــهــا  ؟🍁 ", 
"اكــتــر مـــشــروب بــتــحــبــه  ؟🔥 ", 
"مــتــي يــصــبــح الــحــبــيــب غــريــب؟ 🔥 ", 
"مــتــي يــصــبــح الــغــريــب حــبــيــب ؟💝 ", 
"بـــتــفــرح لــمــا يــحــصــل  ؟💘 ", 
"تـــاريــخ مــيــلادك ؟ 🔥 ", 
"عـــصــيــر ولا بــبــســي  ؟ 🌟 ", 
"كـــلــمــه بــتــحــبــهــا  ؟💝 ", 
"حـــيــوانـــك الــمــفــضــل ؟🌚 ", 
"كـــلــمــه بــتــكــرهــهــا ؟ 🍁 ", 
"بــتــتــمــنــي ٳٲٳيۧ  ؟🍂 ", 
"ردك عــلــي حــد بــتــحــبـه قــالــك خــلــيــنـا  ؟ 🔥 ", 
"حــبــيــت كــام  ؟💘 ", 
"ردك عــلــي حــد قــالــكـ مــعــلــش  ؟🌟 ",
"ٳٲٳيۧ اكـــتـــر حــاجـه بــتــزعــل ؟ 🍁 ", 
"ٳٲٳيۧ الــحــاجــه الــي مــحــتــفــظ بــيــهــا مــن صــغــرك؟💝 ", 
"كــام واحــد خــانــك؟🌚 ", 
"الـــحــب بــالـــنــســبــه لــيــك ٳٲٳيۧ  ؟🪐 ", 
"ســـاد اور هــــابــي؟💕 ", 
"بــتــخــطـط لــمــســتــقــبــلك ولا  ؟🍂 ", 
"مـــوقــف عـــمــرك مــا تـنــســاهه ؟🔥", 
"الــحــب بــالــنــســبه لــيــك ٳٲٳيۧ ؟♥ ", 
"عـــاوز تـــعــتــرف ب اي؟💞 ", 
"مــــودك اي دلــــوقـــت؟🤓", 
"اكـــتـــر اغــنــيـــه بــتــاثــر فــيــــك؟🍂", 
"خــونــت كـــام مـــرهه؟💕", 
" اكـــتــر حـاجــه بــتــخــاف مـــنــها؟💝 ", 
} 
...
local UserName = (b.username_ or "L_e_i_L4")
...
if text == "بوت" then
local Namebot = (database:get(bot_id..'Name:Bot') or 'ليل')
local DRAGON_Msg = {
...
keyboard.inline_keyboard = {
{
{text = 'قناه السورس', url="https://t.me/L_e_i_L4"},
},
}
...
local Teext =[[
 🧸 اهلا في قائمه الالعاب المتطوره سورس ليل 🧸 
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n🧸 لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'L_e_i_L4')..')'
status  = '\n🧸 تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n🧸 العضو » '..userid..''
...
local Name = '[《⬇️اتبع الازرار للتواصل مع》](t.me/L_e_i_L4)\n['..result.first_name_..'](tg://user?id='..result.id_..')\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n🧸 العضو » ['..result.title_..'](t.me/'..(text1[3] or 'L_e_i_L4')..')'..'\n🧸 تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'ليل').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_, msg.id_,'💎╖ ايدِيڪ ⇇'..iduser..'\n☀️╢ يوزرڪ ⇇ '..username..'\n👮‍♂️╢ رتبتك '..rtp..'\n👥╢ جهاتك ⇇ '..Contact..'\n💬╜ رسـائل الجـرۆب '..Msguser..'')
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'L_e_i_L4')..')'
local iduser = result.sender_user_id_
...
send(msg.chat_id_,msg.id_, '[كفايه كدب بقي 😹👻.](t.me/L_e_i_L4)') 
return false
end
...
send(msg.chat_id_,msg.id_, '[يوه خضتني ياسمك اي..🥺💘](t.me/L_e_i_L4)') 
return false
end
...
send(msg.chat_id_,msg.id_, '[خت قلبي 🥺🙈](t.me/L_e_i_L4)') 
return false
end
if text == 'باي' then 
local my_ph = database:get(bot_id.."my_GHoeq2:status"..msg.chat_id_)
...
send(msg.chat_id_,msg.id_, '[باي ي حته مني 🥺💘](t.me/L_e_i_L4)') 
return false
end
if text == 'باي' then 
local my_ph = database:get(bot_id.."my_GHoeq2:status"..msg.chat_id_)
...
send(msg.chat_id_,msg.id_, '[ابقي تعالي كل يوم 🙈](t.me/L_e_i_L4)') 
return false
end

if text == 'مبفتحش والله' then 
local my_ph = database:get(bot_id.."my_GHoeq2:status"..msg.chat_id_)
if not my_ph then
send(msg.chat_id_, msg.id_,"  ") 
return false  
end
send(msg.chat_id_,msg.id_, '[طب لما تفتح كلمني 🥺😂](t.me/L_e_i_L4)') 
return false
end
...
send(msg.chat_id_,msg.id_, '[لف ورجع تاني مش حوار😂](t.me/L_e_i_L4)') 
return false
end

if text == 'عايز مح' then 
local my_ph = database:get(bot_id.."my_GHoeq2:status"..msg.chat_id_)
if not my_ph then
send(msg.chat_id_, msg.id_,"  ") 
return false  
end
send(msg.chat_id_,msg.id_, '[خد يقلبي 💋🥺](t.me/L_e_i_L4)') 
return false
end

if text == 'اضافه وباك' then 
local my_ph = database:get(bot_id.."my_GHoeq2:status"..msg.chat_id_)
if not my_ph then
send(msg.chat_id_, msg.id_,"  ") 
return false  
end
send(msg.chat_id_,msg.id_, '[ضيف هنا ي حب وراقب 😊❤️](t.me/L_e_i_L4)') 
return false
end
...
send(msg.chat_id_,msg.id_, '[مين انا بوت وبحبك..🥺💘](t.me/L_e_i_L4)') 
return false
end
...
send(msg.chat_id_,msg.id_, '[استني لما اخلص واجيلك 🙊💘](t.me/L_e_i_L4)') 
return false
end


if text == 'بباك بس' then 
local my_ph = database:get(bot_id.."my_GHoeq2:status"..msg.chat_id_)
if not my_ph then
send(msg.chat_id_, msg.id_,"  ") 
return false  
end
send(msg.chat_id_,msg.id_, '[باك اي يبني نت هنا في بار الكرم 😹](t.me/L_e_i_L4)') 
return false
end
...
send(msg.chat_id_,msg.id_, '[هو اي ده 😉🌚](t.me/L_e_i_L4)') 
return false
end
...
send(msg.chat_id_,msg.id_, '[تم زوجكم بنجاح خدها وعملو واحد بس مش ف البار 😹🤦](t.me/L_e_i_L4)') 
return false
end
...
send(msg.chat_id_,msg.id_, '[خد انت ي وصخ 🙈،](t.me/L_e_i_L4)') 
return false
end
...
send(msg.chat_id_,msg.id_, '[عيب م قدام الناس 😳🙊](t.me/L_e_i_L4)') 
return false
end
...
send(msg.chat_id_,msg.id_, '[بالتكت بتعها..🙄💔](t.me/L_e_i_L4)') 
return false
end
...
send(msg.chat_id_,msg.id_, '[لف ورجع تاني م حوار 😹💔](t.me/L_e_i_L4)') 
return false
end
...
send(msg.chat_id_,msg.id_, '[كمل يا سالك 😂🤦](t.me/L_e_i_L4)') 
return false
end
...
send(msg.chat_id_,msg.id_, '[ونا كمان يروحي 🌚❤️](t.me/L_e_i_L4)') 
return false
end
...
send(msg.chat_id_,msg.id_, '[بتنقط لي ياحزين..🙂💔](t.me/L_e_i_L4)') 
return false
end
...
send(msg.chat_id_,msg.id_, '[القمر مهو بيضكك اهوه ..🔗💕](t.me/L_e_i_L4)') 
return false
end
...
send(msg.chat_id_,msg.id_, '[صلي الله عليه وسلم](t.me/L_e_i_L4)') 
return false
end
...
send(msg.chat_id_,msg.id_, '[انت الخير ياعمري..❤️](t.me/L_e_i_L4)') 
return false
end


if text == 'الحمد الله' then 
local my_ph = database:get(bot_id.."my_GHoeq2:status"..msg.chat_id_)
if not my_ph then
send(msg.chat_id_, msg.id_,"  ") 
return false  
end
send(msg.chat_id_,msg.id_, '[دايما ياحبيبي..🌚💜](t.me/L_e_i_L4)') 
return false
end

if text == 'انا عايز مح انا كمان 🥺💛' then 
local my_ph = database:get(bot_id.."my_GHoeq2:status"..msg.chat_id_)
if not my_ph then
send(msg.chat_id_, msg.id_,"  ") 
return false  
end
send(msg.chat_id_,msg.id_, '[💋💋💋](t.me/L_e_i_L4)') 
return false
end

if text == 'تعاله الكول' then 
local my_ph = database:get(bot_id.."my_GHoeq2:status"..msg.chat_id_)
if not my_ph then
send(msg.chat_id_, msg.id_,"  ") 
return false  
end
send(msg.chat_id_,msg.id_, '[م فضي والله يعسل 🐾🏋️](t.me/L_e_i_L4)') 
return false
end
...
🧸━━━━━━ 𝙻𝙴𝙸𝙻 ⚠️✨ ━━━━━━🧸
  ...
  {
  {text = '🧸𝚂𝙾𝚄𝚁𝙲𝙴 𝙻𝙴𝙸𝙻🧸', url="t.me/L_e_i_L4"},
  },
  }
local msg_id = msg.id_/2097152/0.5
